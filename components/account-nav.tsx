...
import { Gift, Heart, LogOut, Receipt, UserRound } from 'lucide-react'
...
export function AccountNav() {
  ...
  return (
    <nav className="flex gap-2 overflow-x-auto pb-1">
      ...
      <button
        onClick={logout}
        className="inline-flex shrink-0 items-center gap-2 rounded-full border border-border bg-card px-4 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground"
      >
